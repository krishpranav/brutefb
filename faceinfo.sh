...
read -p $'\e[1;92mTarget Facebook Accout: \e[0m' EMAIL
...
printf "\e[1;92mUse ./faceinfo.sh --resume\n"
else
exit 1
fi
}
...
printf "\e[1;92mEnter Your Target Facebook Account:\e[0m\e[1;77m %s\e[0m\n" $EMAIL
